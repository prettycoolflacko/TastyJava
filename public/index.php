<?php 
// 1. Set judul halaman
$page_title = 'Selamat Datang di Dapur Resep Sederhana';
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div id="carousel" class="relative overflow-hidden rounded-lg shadow-lg">
        ...
        <div class="carousel-slides relative h-[420px] md:h-[520px]">
          <div class="carousel-item absolute inset-0 transition-opacity duration-700 ease-in-out opacity-100" data-index="0" aria-hidden="false">
            <img src="https://images.unsplash.com/photo-1556910103-1c02745aae4d?auto=format&fit=crop&q=80&w=1600" alt="Dapur Resep 1" class="w-full h-full object-cover">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-start md:items-center text-left md:text-center px-6 md:px-12 text-white">
              <h2 class="text-3xl md:text-5xl font-extrabold drop-shadow-lg leading-tight">🍳 Selamat Datang di Dapur Resep</h2>
              <p class="mt-4 text-sm md:text-lg text-white/90 max-w-3xl">Temukan resep masakan sederhana dan lezat untuk keluarga Anda — berbagi cita rasa nusantara dan dunia.</p>
          ...
          <div class="carousel-item absolute inset-0 transition-opacity duration-700 ease-in-out opacity-0" data-index="2" aria-hidden="true">
            <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&q=80&w=1600" alt="Berbagi Resep" class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-gradient-to-b from-black/40 to-black/30"></div>
            <div class="absolute inset-0 flex flex-col justify-center items-start md:items-center text-left md:text-center px-6 md:px-12 text-white">
          ...
          <article class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 hover:shadow-xl transition duration-300">
            ...
            <div class="p-5">
              ...
              <div class="mt-4 flex items-center justify-between">
                ...
                <span class="text-xs text-gray-400">• Mudah dibuat</span>
              </div>
            </div>
          </article>
        <?php endforeach; ?>
  ...
  <section class="mb-12 bg-gradient-to-r from-red-50 to-orange-50 rounded-lg p-8">
    <div class="max-w-4xl mx-auto text-center">
      <h2 class="text-2xl font-semibold text-primary">Tentang Dapur Resep</h2>
      <p class="mt-3 text-gray-700">
        Dapur Resep adalah platform berbagi resep masakan yang dibuat untuk memudahkan Anda menemukan inspirasi masakan.
  ...
  <section class="mb-16">
    <div class="bg-white rounded-lg shadow-md p-6 flex flex-col md:flex-row items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-3">
        <!-- Instagram -->
        <a href="https://instagram.com/dapurresep" target="_blank" rel="noopener" class="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-r from-pink-500 to-yellow-400 shadow hover:scale-110 transition-transform" aria-label="Instagram">
        ...
        <!-- WhatsApp -->
        <a href="https://wa.me/6281234567890" target="_blank" rel="noopener" class="w-10 h-10 flex items-center justify-center rounded-full bg-green-500 shadow hover:scale-110 transition-transform" aria-label="WhatsApp">
        ...
        <!-- Twitter -->
        <a href="https://twitter.com/dapurresep" target="_blank" rel="noopener" class="w-10 h-10 flex items-center justify-center rounded-full bg-blue-400 shadow hover:scale-110 transition-transform" aria-label="Twitter">
        ...
        <!-- Facebook -->
        <a href="https://facebook.com/dapurresep" target="_blank" rel="noopener" class="w-10 h-10 flex items-center justify-center rounded-full bg-blue-600 shadow hover:scale-110 transition-transform" aria-label="Facebook">
